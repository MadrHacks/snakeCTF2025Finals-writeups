...
### Crypto part
After the reversing part, the pcap can be organized in the following way:
 ...
 * UAVs exchange flag's halfs (packets 12, 13)
...
(Figure for the first 4 messages)
